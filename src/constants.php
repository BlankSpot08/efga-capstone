...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "18.8.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "efga_expense_system"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{4EB84F2A-5676-4E71-AB80-D3ECF349B44C}"); // Project ID
