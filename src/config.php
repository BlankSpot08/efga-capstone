...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'l7ooZE81cFvoNb77', // Random key for encryption
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-dark-gray-dark",
    ...
    "USER_PROFILE_SESSION_TIMEOUT" => 30,
    ...
    */
    ...
    "CHART_SHOW_MISSING_SERIES_VALUES_AS_ZERO" => false, // Show missing series values as zero
