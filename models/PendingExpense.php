...
/**
 * Table class for pending_expense
 */
class PendingExpense extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'pending_expense';
        $this->TableName = 'pending_expense';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->cashAdvance_id->Lookup = new Lookup('cashAdvance_id', 'cash_advance', false, 'id', ["expCategory_id","expSubcategory_id","submittedBy",""], [], ["x_expCategory_id"], [], [], [], [], '', '', "CONCAT(COALESCE(`expCategory_id`, ''),'" . ValueSeparator(1, $this->cashAdvance_id) . "',COALESCE(`expSubcategory_id`,''),'" . ValueSeparator(2, $this->cashAdvance_id) . "',COALESCE(`submittedBy`,''))");
                break;
            default:
                $this->cashAdvance_id->Lookup = new Lookup('cashAdvance_id', 'cash_advance', false, 'id', ["expCategory_id","expSubcategory_id","submittedBy",""], [], ["x_expCategory_id"], [], [], [], [], '', '', "CONCAT(COALESCE(`expCategory_id`, ''),'" . ValueSeparator(1, $this->cashAdvance_id) . "',COALESCE(`expSubcategory_id`,''),'" . ValueSeparator(2, $this->cashAdvance_id) . "',COALESCE(`submittedBy`,''))");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'pending_expense', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'pending_expense', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup('status', 'pending_expense', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'pending_expense', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->float_status->Lookup = new Lookup('float_status', 'pending_expense', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->float_status->Lookup = new Lookup('float_status', 'pending_expense', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->validatedBy->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->machine_id->Lookup = new Lookup('machine_id', 'machine', false, 'id', ["model","","",""], [], [], [], [], [], [], '`id` ASC', '', "`model`");
                break;
            default:
                $this->machine_id->Lookup = new Lookup('machine_id', 'machine', false, 'id', ["model","","",""], [], [], [], [], [], [], '`id` ASC', '', "`model`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->expCategory_id->Lookup = new Lookup('expCategory_id', 'emp_expense_category', false, 'id', ["expCategory","","",""], ["x_cashAdvance_id"], [], ["expCategory"], ["x_expCategory"], [], [], '', '', "`expCategory`");
                break;
            default:
                $this->expCategory_id->Lookup = new Lookup('expCategory_id', 'emp_expense_category', false, 'id', ["expCategory","","",""], ["x_cashAdvance_id"], [], ["expCategory"], ["x_expCategory"], [], [], '', '', "`expCategory`");
                break;
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "`float_status` = '0'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PendingExpenseList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PendingExpenseView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PendingExpenseEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PendingExpenseAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PendingExpenseView";
            case Config("API_ADD_ACTION"):
                return "PendingExpenseAdd";
            case Config("API_EDIT_ACTION"):
                return "PendingExpenseEdit";
            case Config("API_DELETE_ACTION"):
                return "PendingExpenseDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PendingExpenseView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PendingExpenseView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PendingExpenseAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PendingExpenseAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PendingExpenseEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PendingExpenseAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PendingExpenseDelete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->receipt->UseColorbox) {
            ...
            $this->receipt->LinkAttrs["data-rel"] = "pending_expense_x_receipt";
    ...
    public function renderEditRow()
    {
        ...
        $this->dateTrans->EditValue = $this->dateTrans->CurrentValue;
        $this->dateTrans->EditValue = FormatDateTime($this->dateTrans->EditValue, $this->dateTrans->formatPattern());
        $this->dateTrans->ViewCustomAttributes = "";
        ...
        $this->dateClosed->EditValue = FormatDateTime($this->dateClosed->CurrentValue, $this->dateClosed->formatPattern());
