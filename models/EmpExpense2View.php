 ...
 * Page class
 */
class EmpExpense2View extends EmpExpense2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpense2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmpExpense2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmpExpense2List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmpExpense2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
