 ...
 */
class EmployeeDashboard2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'EmployeeDashboard2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'EmployeeDashboard2', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'EmployeeDashboard2', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'EmployeeDashboard2', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'EmployeeDashboard2', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup('status', 'EmployeeDashboard2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'EmployeeDashboard2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->float_status->Lookup = new Lookup('float_status', 'EmployeeDashboard2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->float_status->Lookup = new Lookup('float_status', 'EmployeeDashboard2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeeDashboard2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeeDashboard2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeeDashboard2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeeDashboard2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeeDashboard2View";
            case Config("API_ADD_ACTION"):
                return "EmployeeDashboard2Add";
            case Config("API_EDIT_ACTION"):
                return "EmployeeDashboard2Edit";
            case Config("API_DELETE_ACTION"):
                return "EmployeeDashboard2Delete";
            case Config("API_LIST_ACTION"):
                return "EmployeeDashboard2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeeDashboard2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeeDashboard2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeeDashboard2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeeDashboard2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeDashboard2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeeDashboard2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeeDashboard2Delete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->receipt->UseColorbox) {
            ...
            $this->receipt->LinkAttrs["data-rel"] = "EmployeeDashboard2_x_receipt";
