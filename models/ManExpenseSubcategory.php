...
/**
 * Table class for man_expense_subcategory
 */
class ManExpenseSubcategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'man_expense_subcategory';
        $this->TableName = 'man_expense_subcategory';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`man_expense_subcategory`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->expCategory->Lookup = new Lookup('expCategory', 'man_expense_category', false, 'id', ["expCategory","","",""], [], [], [], [], [], [], '', '', "`expCategory`");
                break;
            default:
                $this->expCategory->Lookup = new Lookup('expCategory', 'man_expense_category', false, 'id', ["expCategory","","",""], [], [], [], [], [], [], '', '', "`expCategory`");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`man_expense_subcategory`";
    }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `expCategory` FROM `man_expense_category` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id` = `man_expense_subcategory`.`expCategory` LIMIT 1) AS `EV__expCategory` FROM `man_expense_subcategory`)";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ManExpenseSubcategoryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ManExpenseSubcategoryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ManExpenseSubcategoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ManExpenseSubcategoryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ManExpenseSubcategoryView";
            case Config("API_ADD_ACTION"):
                return "ManExpenseSubcategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "ManExpenseSubcategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "ManExpenseSubcategoryDelete";
            case Config("API_LIST_ACTION"):
                return "ManExpenseSubcategoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ManExpenseSubcategoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ManExpenseSubcategoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ManExpenseSubcategoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ManExpenseSubcategoryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ManExpenseSubcategoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ManExpenseSubcategoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ManExpenseSubcategoryDelete", $this->getUrlParm());
    }
