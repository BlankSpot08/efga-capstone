 ...
 * Page class
 */
class ExpenseMonthlySummary extends ExpenseMonthly
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Expense Monthly';

    // Page object name
    public $PageObjName = "ExpenseMonthlySummary";
    ...
    public function __construct()
    {
        ...
        // Table object (ExpenseMonthly)
        if (!isset($GLOBALS["ExpenseMonthly"]) || get_class($GLOBALS["ExpenseMonthly"]) == PROJECT_NAMESPACE . "ExpenseMonthly") {
            $GLOBALS["ExpenseMonthly"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Expense Monthly');
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fExpenseMonthlysrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fExpenseMonthlysrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
