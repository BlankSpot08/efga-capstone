 ...
 * Page class
 */
class EmployeePositionView extends EmployeePosition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeePositionView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeePositionList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmployeePositionList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmployeePositionList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
