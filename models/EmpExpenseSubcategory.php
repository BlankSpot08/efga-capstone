...
/**
 * Table class for emp_expense_subcategory
 */
class EmpExpenseSubcategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'emp_expense_subcategory';
        $this->TableName = 'emp_expense_subcategory';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`emp_expense_subcategory`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->expCategory->Lookup = new Lookup('expCategory', 'emp_expense_category', false, 'id', ["expCategory","","",""], [], [], [], [], [], [], '`id` ASC', '', "`expCategory`");
                break;
            default:
                $this->expCategory->Lookup = new Lookup('expCategory', 'emp_expense_category', false, 'id', ["expCategory","","",""], [], [], [], [], [], [], '`id` ASC', '', "`expCategory`");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`emp_expense_subcategory`";
    }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `expCategory` FROM `emp_expense_category` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id` = `emp_expense_subcategory`.`expCategory` LIMIT 1) AS `EV__expCategory` FROM `emp_expense_subcategory`)";
    ...
    protected function useVirtualFields()
    {
        ...
        if (ContainsString($orderBy, " " . $this->expCategory->VirtualExpression . " ")) {
            return true;
        }
        return false;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmpExpenseSubcategoryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmpExpenseSubcategoryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmpExpenseSubcategoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmpExpenseSubcategoryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmpExpenseSubcategoryView";
            case Config("API_ADD_ACTION"):
                return "EmpExpenseSubcategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "EmpExpenseSubcategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "EmpExpenseSubcategoryDelete";
            case Config("API_LIST_ACTION"):
                return "EmpExpenseSubcategoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmpExpenseSubcategoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmpExpenseSubcategoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmpExpenseSubcategoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmpExpenseSubcategoryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmpExpenseSubcategoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmpExpenseSubcategoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmpExpenseSubcategoryDelete", $this->getUrlParm());
    }
