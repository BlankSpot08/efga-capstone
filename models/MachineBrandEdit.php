 ...
 * Page class
 */
class MachineBrandEdit extends MachineBrand
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineBrandEdit";
    ...
    protected function editRow()
    {
        ...
        if ($this->brand->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`brand` = '" . AdjustSql($this->brand->CurrentValue, $this->Dbid) . "')";
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['brand']); // brand
        return md5($hash);
    }
