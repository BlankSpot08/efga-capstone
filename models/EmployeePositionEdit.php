 ...
 * Page class
 */
class EmployeePositionEdit extends EmployeePosition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeePositionEdit";
    ...
    protected function editRow()
    {
        ...
        if ($this->position->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`position` = '" . AdjustSql($this->position->CurrentValue, $this->Dbid) . "')";
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['position']); // position
        return md5($hash);
    }
