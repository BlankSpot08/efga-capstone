 ...
 * Page class
 */
class MachineDelete extends Machine
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MachineList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MachineList"); // Return to list
                return;
            }
        }
