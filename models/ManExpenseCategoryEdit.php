 ...
 * Page class
 */
class ManExpenseCategoryEdit extends ManExpenseCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseCategoryEdit";
    ...
    protected function editRow()
    {
        ...
        if ($this->expCategory->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`expCategory` = '" . AdjustSql($this->expCategory->CurrentValue, $this->Dbid) . "')";
