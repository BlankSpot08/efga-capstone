 ...
 * Page class
 */
class EmpExpenseDelete extends EmpExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpenseDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmpExpenseList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("EmpExpenseList"); // Return to list
            return;
        }
