...
/**
 * Table class for Utilities Expense
 */
class UtilitiesExpense extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'UtilitiesExpense';
        $this->TableName = 'Utilities Expense';
        $this->TableType = 'REPORT';

        // Update Table
        $this->UpdateTable = "`utilities`";
        $this->ReportSourceTable = 'utilities'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->expSubcategory->SourceTableVar = 'utilities';
        ...
        $this->expCategory->SourceTableVar = 'utilities';
        ...
        $this->amount->SourceTableVar = 'utilities';
        ...
        $this->receiptNumber->SourceTableVar = 'utilities';
        ...
        $this->date->SourceTableVar = 'utilities';
        ...
        $this->consumption->SourceTableVar = 'utilities';
        ...
        $this->note->SourceTableVar = 'utilities';
        $this->Fields['note'] = &$this->note;

        // Utilities Expense
        $this->UtilitiesExpense = new DbChart($this, 'UtilitiesExpense', 'Utilities Expense', 'expSubcategory', 'amount', 1001, '', 0, 'SUM', 600, 500);
        $this->UtilitiesExpense->YAxisFormat = ["Number"];
        $this->UtilitiesExpense->YFieldFormat = ["Number"];
        $this->UtilitiesExpense->SortType = 0;
        $this->UtilitiesExpense->SortSequence = "";
        $this->UtilitiesExpense->SqlSelect = $this->getQueryBuilder()->select("`expSubcategory`", "''", "SUM(`amount`)");
        $this->UtilitiesExpense->SqlGroupBy = "`expSubcategory`";
        $this->UtilitiesExpense->SqlOrderBy = "";
        $this->UtilitiesExpense->SeriesDateType = "";
        $this->UtilitiesExpense->ID = "UtilitiesExpense_UtilitiesExpense"; // Chart ID
        $this->UtilitiesExpense->setParameters([
            ["type", "1001"],
            ["seriestype", "0"]
        ]); // Chart type / Chart series type
        $this->UtilitiesExpense->setParameters([
            ["caption", $this->UtilitiesExpense->caption()],
            ["xaxisname", $this->UtilitiesExpense->xAxisName()]
        ]); // Chart caption / X axis name
        $this->UtilitiesExpense->setParameter("yaxisname", $this->UtilitiesExpense->yAxisName()); // Y axis name
        $this->UtilitiesExpense->setParameters([
            ["shownames", "1"],
            ["showvalues", "1"],
            ["showhovercap", "1"]
        ]); // Show names / Show values / Show hover
        $this->UtilitiesExpense->setParameter("alpha", "50"); // Chart alpha
        $this->UtilitiesExpense->setParameter("colorpalette", "#5899DA,#E8743B,#19A979,#ED4A7B,#945ECF,#13A4B4,#525DF4,#BF399E,#6C8893,#EE6868,#2F6497"); // Chart color palette
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`utilities`";
    }
