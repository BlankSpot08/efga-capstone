 ...
 * Page class
 */
class UtilitiesExpenseSummary extends UtilitiesExpense
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Utilities Expense';

    // Page object name
    public $PageObjName = "UtilitiesExpenseSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (UtilitiesExpense)
        if (!isset($GLOBALS["UtilitiesExpense"]) || get_class($GLOBALS["UtilitiesExpense"]) == PROJECT_NAMESPACE . "UtilitiesExpense") {
            $GLOBALS["UtilitiesExpense"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Utilities Expense');
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->date->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fUtilitiesExpensesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fUtilitiesExpensesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
