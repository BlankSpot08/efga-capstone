 ...
 * Page class
 */
class CashAdvanceRequestAdd extends CashAdvanceRequest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceRequestAdd";
    ...
    public function run()
    {
        ...
        $this->expSubcategory_id->Visible = false;
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("CashAdvanceRequestList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "CashAdvanceRequestList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "CashAdvanceRequestView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->submittedBy->CurrentValue = null;
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CashAdvanceRequestList"), "", $this->TableVar, true);
