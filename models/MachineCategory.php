...
/**
 * Table class for machine_category
 */
class MachineCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'machine_category';
        $this->TableName = 'machine_category';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`machine_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`machine_category`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MachineCategoryList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MachineCategoryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MachineCategoryAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MachineCategoryView";
            case Config("API_ADD_ACTION"):
                return "MachineCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "MachineCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "MachineCategoryDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MachineCategoryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MachineCategoryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MachineCategoryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MachineCategoryAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MachineCategoryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MachineCategoryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MachineCategoryDelete", $this->getUrlParm());
    }
