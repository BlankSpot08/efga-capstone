 ...
 * Page class
 */
class ManExpenseDelete extends ManExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ManExpenseList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ManExpenseList"); // Return to list
                return;
            }
        }
