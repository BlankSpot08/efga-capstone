 ...
 * Page class
 */
class EmployeeDashboard22Grid extends EmployeeDashboard22
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeDashboard22Grid";
    ...
    public $FormName = "fEmployeeDashboard22grid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->machine_id->getSessionValue() != "") {
            $rsnew['machine_id'] = $this->machine_id->getSessionValue();
        }
