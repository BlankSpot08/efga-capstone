...
/**
 * Table class for summary
 */
class Summary extends DbTable
{
    protected $SqlFrom = "";
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`summary`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("SummaryList");
    }
    ...
    {
        global $Language;
        if ($pageName == "SummaryView") {
            return $Language->phrase("View");
        } elseif ($pageName == "SummaryEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "SummaryAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("SummaryView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("SummaryView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "SummaryAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "SummaryAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("SummaryEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("SummaryAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("SummaryDelete", $this->getUrlParm());
    }
