 ...
 * Page class
 */
class ChangePassword extends UserAccount
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("user_account", "user_account", "opwd", "opwd", "opwd", "", 202, 255, -1, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->NewPassword = new DbField("user_account", "user_account", "npwd", "npwd", "npwd", "", 202, 255, -1, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->ConfirmPassword = new DbField("user_account", "user_account", "cpwd", "cpwd", "cpwd", "", 202, 255, -1, false, "", false, false, false);
