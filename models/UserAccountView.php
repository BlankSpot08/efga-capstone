 ...
 * Page class
 */
class UserAccountView extends UserAccount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserAccountView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "UserAccountList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "UserAccountList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "UserAccountList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
