 ...
 * Page class
 */
class EmpExpenseView extends EmpExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpenseView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmpExpenseList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmpExpenseList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmpExpenseList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
