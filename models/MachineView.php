 ...
 * Page class
 */
class MachineView extends Machine
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MachineList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MachineList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MachineList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
