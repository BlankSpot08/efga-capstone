 ...
 * Page class
 */
class EmpExpenseSubcategoryAdd extends EmpExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpenseSubcategoryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("EmpExpenseSubcategoryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "EmpExpenseSubcategoryList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "EmpExpenseSubcategoryView") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmpExpenseSubcategoryList"), "", $this->TableVar, true);
