...
/**
 * Table class for employee monthly expense
 */
class Employeemonthlyexpense extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employeemonthlyexpense';
        $this->TableName = 'employee monthly expense';
        $this->TableType = 'VIEW';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->expSubcategory->Lookup = new Lookup('expSubcategory', 'employeemonthlyexpense', true, 'expSubcategory', ["expSubcategory","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->expSubcategory->Lookup = new Lookup('expSubcategory', 'employeemonthlyexpense', true, 'expSubcategory', ["expSubcategory","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->expCategory->Lookup = new Lookup('expCategory', 'employeemonthlyexpense', true, 'expCategory', ["expCategory","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->expCategory->Lookup = new Lookup('expCategory', 'employeemonthlyexpense', true, 'expCategory', ["expCategory","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'employeemonthlyexpense', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'employeemonthlyexpense', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'employeemonthlyexpense', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'employeemonthlyexpense', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->dateClosed->Lookup = new Lookup('dateClosed', 'employeemonthlyexpense', true, 'dateClosed', ["dateClosed","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->dateClosed->Lookup = new Lookup('dateClosed', 'employeemonthlyexpense', true, 'dateClosed', ["dateClosed","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->validatedBy->Lookup = new Lookup('validatedBy', 'employeemonthlyexpense', true, 'validatedBy', ["validatedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->validatedBy->Lookup = new Lookup('validatedBy', 'employeemonthlyexpense', true, 'validatedBy', ["validatedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeemonthlyexpenseList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeemonthlyexpenseView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeemonthlyexpenseEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeemonthlyexpenseAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmployeemonthlyexpenseView";
            case Config("API_ADD_ACTION"):
                return "EmployeemonthlyexpenseAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeemonthlyexpenseEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeemonthlyexpenseDelete";
            case Config("API_LIST_ACTION"):
                return "EmployeemonthlyexpenseList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeemonthlyexpenseView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeemonthlyexpenseView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeemonthlyexpenseAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeemonthlyexpenseAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeemonthlyexpenseEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeemonthlyexpenseAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeemonthlyexpenseDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->expCategory->Raw) {
            $this->expCategory->CurrentValue = HtmlDecode($this->expCategory->CurrentValue);
        }
        $this->expCategory->EditValue = $this->expCategory->CurrentValue;
