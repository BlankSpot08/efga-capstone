 ...
 * Page class
 */
class ManExpenseSubcategoryDelete extends ManExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseSubcategoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ManExpenseSubcategoryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ManExpenseSubcategoryList"); // Return to list
                return;
            }
        }
