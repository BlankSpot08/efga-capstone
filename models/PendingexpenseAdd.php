 ...
 * Page class
 */
class PendingexpenseAdd extends Pendingexpense
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'pending expense';

    // Page object name
    public $PageObjName = "PendingexpenseAdd";
    ...
    public function __construct()
    {
        ...
        // Table object (pendingexpense)
        if (!isset($GLOBALS["pendingexpense"]) || get_class($GLOBALS["pendingexpense"]) == PROJECT_NAMESPACE . "pendingexpense") {
            $GLOBALS["pendingexpense"] = &$this;
        }

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'pending expense');
        }
    ...
    public function run()
    {
        ...
        $this->id->Visible = false;
        $this->cashAdvance_id->Visible = false;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PendingexpenseView") {
            ...
            if ($curVal != "") {
                ...
                if ($this->cashAdvance_id->ViewValue === null) { // Lookup from database
                    ...
                    $lookupFilter = function() {
                        return "`submittedBy` = '" . CurrentUserName() . "' AND `used` = '0'";
                    };
