...
/**
 * Table class for Employee Dashboarddd
 */
class EmployeeDashboarddd extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'EmployeeDashboarddd';
        $this->TableName = 'Employee Dashboarddd';
        $this->TableType = 'REPORT';

        // Update Table
        $this->UpdateTable = "`emp_expense`";
        $this->ReportSourceTable = 'EmployeeDashboard2'; // Report source table
        $this->Dbid = 'capstone1';
        $this->ExportAll = true;
        ...
        $this->id->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->cashAdvance_id->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->amount->SourceTableVar = 'EmployeeDashboard2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'EmployeeDashboarddd', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->dateTrans->Lookup = new Lookup('dateTrans', 'EmployeeDashboarddd', true, 'dateTrans', ["dateTrans","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->dateTrans->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->receiptNumber->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->receipt->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->note->SourceTableVar = 'EmployeeDashboard2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'EmployeeDashboarddd', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->submittedBy->Lookup = new Lookup('submittedBy', 'EmployeeDashboarddd', true, 'submittedBy', ["submittedBy","","",""], [], [], [], [], [], [], '', '', "");
                break;
        }
        $this->submittedBy->SourceTableVar = 'EmployeeDashboard2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup('status', 'EmployeeDashboarddd', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'EmployeeDashboarddd', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->status->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->dateClosed->SourceTableVar = 'EmployeeDashboard2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->float_status->Lookup = new Lookup('float_status', 'EmployeeDashboarddd', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->float_status->Lookup = new Lookup('float_status', 'EmployeeDashboarddd', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->float_status->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->cash_float->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->validatedBy->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->machine_id->SourceTableVar = 'EmployeeDashboard2';
        ...
        $this->expCategory_id->SourceTableVar = 'EmployeeDashboard2';
