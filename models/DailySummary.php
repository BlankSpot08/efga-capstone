 ...
 * Page class
 */
class DailySummary extends Daily
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'daily';

    // Page object name
    public $PageObjName = "DailySummary";
    ...
    public function __construct()
    {
        ...
        // Table object (daily)
        if (!isset($GLOBALS["daily"]) || get_class($GLOBALS["daily"]) == PROJECT_NAMESPACE . "daily") {
            $GLOBALS["daily"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'daily');
        }
    ...
    public function run()
    {
        ...
        $this->Sumemp_expenseamount->setVisibility();
    ...
    public function loadRowValues($record)
    {
        ...
        $data["Sumemp_expenseamount"] = $record['Sum(emp_expense.amount)'];
        $this->Rows[] = $data;
        $this->expCategory_id->setDbValue($record['expCategory_id']);
        $this->Sumemp_expenseamount->setDbValue($record['Sum(emp_expense.amount)']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            // Sum(emp_expense.amount)
            $this->Sumemp_expenseamount->HrefValue = "";
        } else {
            ...
            // Sum(emp_expense.amount)
            $this->Sumemp_expenseamount->ViewValue = $this->Sumemp_expenseamount->CurrentValue;
            $this->Sumemp_expenseamount->ViewValue = FormatNumber($this->Sumemp_expenseamount->ViewValue, $this->Sumemp_expenseamount->formatPattern());
            $this->Sumemp_expenseamount->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            $this->Sumemp_expenseamount->ViewCustomAttributes = "";
            ...
            // Sum(emp_expense.amount)
            $this->Sumemp_expenseamount->LinkCustomAttributes = "";
            $this->Sumemp_expenseamount->HrefValue = "";
            $this->Sumemp_expenseamount->TooltipValue = "";
        }
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // Sum(emp_expense.amount)
            $currentValue = $this->Sumemp_expenseamount->CurrentValue;
            $viewValue = &$this->Sumemp_expenseamount->ViewValue;
            $viewAttrs = &$this->Sumemp_expenseamount->ViewAttrs;
            $cellAttrs = &$this->Sumemp_expenseamount->CellAttrs;
            $hrefValue = &$this->Sumemp_expenseamount->HrefValue;
            $linkAttrs = &$this->Sumemp_expenseamount->LinkAttrs;
            $this->cellRendered($this->Sumemp_expenseamount, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->Sumemp_expenseamount->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdailysrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdailysrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    protected function getSort()
    {
        ...
        if ($resetSort) {
            ...
            $this->Sumemp_expenseamount->setSort("");
        ...
        // Check for an Order parameter
            ...
            $this->updateSort($this->Sumemp_expenseamount); // Sum(emp_expense.amount)
