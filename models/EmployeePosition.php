...
/**
 * Table class for employee_position
 */
class EmployeePosition extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'employee_position';
        $this->TableName = 'employee_position';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`employee_position`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->officeDepartment->Lookup = new Lookup('officeDepartment', 'office_department', false, 'id', ["officeDepartment","","",""], [], [], [], [], [], [], '`id` ASC', '', "`officeDepartment`");
                break;
            default:
                $this->officeDepartment->Lookup = new Lookup('officeDepartment', 'office_department', false, 'id', ["officeDepartment","","",""], [], [], [], [], [], [], '`id` ASC', '', "`officeDepartment`");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`employee_position`";
    }
    ...
    public function getSqlSelectList() // Select for List page
    {
        ...
        $from = "(SELECT *, (SELECT `officeDepartment` FROM `office_department` `TMP_LOOKUPTABLE` WHERE `TMP_LOOKUPTABLE`.`id` = `employee_position`.`officeDepartment` LIMIT 1) AS `EV__officeDepartment` FROM `employee_position`)";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmployeePositionList");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmployeePositionView") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmployeePositionEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmployeePositionAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "EmployeePositionAdd";
            case Config("API_EDIT_ACTION"):
                return "EmployeePositionEdit";
            case Config("API_DELETE_ACTION"):
                return "EmployeePositionDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmployeePositionView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmployeePositionView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmployeePositionAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "EmployeePositionAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeePositionEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmployeePositionAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmployeePositionDelete", $this->getUrlParm());
    }
