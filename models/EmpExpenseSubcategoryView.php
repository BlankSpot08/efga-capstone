 ...
 * Page class
 */
class EmpExpenseSubcategoryView extends EmpExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpenseSubcategoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmpExpenseSubcategoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmpExpenseSubcategoryList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmpExpenseSubcategoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
