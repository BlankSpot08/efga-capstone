...
class Login extends UserAccount
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("user_account", "user_account", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("user_account", "user_account", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("user_account", "user_account", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
