 ...
 * Page class
 */
class ExpenseYesterdaySummary extends ExpenseYesterday
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Expense Yesterday';

    // Page object name
    public $PageObjName = "ExpenseYesterdaySummary";
    ...
    public function __construct()
    {
        ...
        // Table object (ExpenseYesterday)
        if (!isset($GLOBALS["ExpenseYesterday"]) || get_class($GLOBALS["ExpenseYesterday"]) == PROJECT_NAMESPACE . "ExpenseYesterday") {
            $GLOBALS["ExpenseYesterday"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Expense Yesterday');
        }
    ...
    {
        $data = [];
        $data["SUMaemp_amount"] = $record['SUM(a.emp_amount)'];
        $this->Rows[] = $data;
        $this->SUMaemp_amount->setDbValue($record['SUM(a.emp_amount)']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->SUMaemp_amount->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // SUM(a.emp_amount)
            $currentValue = $this->SUMaemp_amount->CurrentValue;
            $viewValue = &$this->SUMaemp_amount->ViewValue;
            $viewAttrs = &$this->SUMaemp_amount->ViewAttrs;
            $cellAttrs = &$this->SUMaemp_amount->CellAttrs;
            $hrefValue = &$this->SUMaemp_amount->HrefValue;
            $linkAttrs = &$this->SUMaemp_amount->LinkAttrs;
            $this->cellRendered($this->SUMaemp_amount, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->SUMaemp_amount->Visible) {
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fExpenseYesterdaysrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fExpenseYesterdaysrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
