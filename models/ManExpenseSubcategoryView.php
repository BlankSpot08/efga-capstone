 ...
 * Page class
 */
class ManExpenseSubcategoryView extends ManExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseSubcategoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ManExpenseSubcategoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ManExpenseSubcategoryList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "ManExpenseSubcategoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
