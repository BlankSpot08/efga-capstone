 ...
 * Page class
 */
class PendingExpenseView extends PendingExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendingExpenseView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PendingExpenseList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PendingExpenseList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PendingExpenseList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
