 ...
 * Page class
 */
class MachineBrandView extends MachineBrand
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineBrandView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MachineBrandList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MachineBrandList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MachineBrandList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
