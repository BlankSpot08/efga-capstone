...
/**
 * Table class for daily
 */
class Daily extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'view1'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->expCategory_id->SourceTableVar = 'view1';
        $this->Fields['expCategory_id'] = &$this->expCategory_id;

        // Sum(emp_expense.amount)
        $this->Sumemp_expenseamount = new ReportField(
            'daily',
            'daily',
            'x_Sumemp_expenseamount',
            'Sum(emp_expense.amount)',
            '`Sum(emp_expense.amount)`',
            '`Sum(emp_expense.amount)`',
            131,
        ...
        $this->Sumemp_expenseamount->InputTextType = "text";
        $this->Sumemp_expenseamount->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->Sumemp_expenseamount->SourceTableVar = 'view1';
        $this->Fields['Sum(emp_expense.amount)'] = &$this->Sumemp_expenseamount;
