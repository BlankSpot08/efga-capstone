 ...
 * Page class
 */
class ManExpenseSubcategoryAdd extends ManExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseSubcategoryAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("ManExpenseSubcategoryList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ManExpenseSubcategoryList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ManExpenseSubcategoryView") {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->expSubcategory->EditValue = HtmlEncode($this->expSubcategory->CurrentValue);
    ...
    {
        global $Language, $Security;
        if ($this->expSubcategory->CurrentValue != "") { // Check field with unique index
            $filter = "(`expSubcategory` = '" . AdjustSql($this->expSubcategory->CurrentValue, $this->Dbid) . "')";
            $rsChk = $this->loadRs($filter)->fetch();
            if ($rsChk !== false) {
                $idxErrMsg = str_replace("%f", $this->expSubcategory->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->expSubcategory->CurrentValue, $idxErrMsg);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ManExpenseSubcategoryList"), "", $this->TableVar, true);
