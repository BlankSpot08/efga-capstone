 ...
 * Page class
 */
class CashAdvanceRequestView extends CashAdvanceRequest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceRequestView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CashAdvanceRequestList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "CashAdvanceRequestList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "CashAdvanceRequestList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
