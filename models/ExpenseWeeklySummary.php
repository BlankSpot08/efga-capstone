 ...
 * Page class
 */
class ExpenseWeeklySummary extends ExpenseWeekly
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Expense Weekly';

    // Page object name
    public $PageObjName = "ExpenseWeeklySummary";
    ...
    public function __construct()
    {
        ...
        // Table object (ExpenseWeekly)
        if (!isset($GLOBALS["ExpenseWeekly"]) || get_class($GLOBALS["ExpenseWeekly"]) == PROJECT_NAMESPACE . "ExpenseWeekly") {
            $GLOBALS["ExpenseWeekly"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Expense Weekly');
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fExpenseWeeklysrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fExpenseWeeklysrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
