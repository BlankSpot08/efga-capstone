 ...
 * Page class
 */
class MachineEdit extends Machine
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // machine_category_id
            $this->machine_category_id->setDbValueDef($rsnew, $this->machine_category_id->CurrentValue, null, $this->machine_category_id->ReadOnly);
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['machine_category_id']); // machine_category_id
