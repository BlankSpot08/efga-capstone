 ...
 * Page class
 */
class ExpenseTodaySummary extends ExpenseToday
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Expense Today';

    // Page object name
    public $PageObjName = "ExpenseTodaySummary";
    ...
    public function __construct()
    {
        ...
        // Table object (ExpenseToday)
        if (!isset($GLOBALS["ExpenseToday"]) || get_class($GLOBALS["ExpenseToday"]) == PROJECT_NAMESPACE . "ExpenseToday") {
            $GLOBALS["ExpenseToday"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Expense Today');
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fExpenseTodaysrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fExpenseTodaysrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
