 ...
 * Page class
 */
class CashAdvanceDelete extends CashAdvance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CashAdvanceList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("CashAdvanceList"); // Return to list
            return;
        }
