 ...
 * Page class
 */
class BudgetDelete extends Budget
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BudgetDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BudgetList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BudgetList"); // Return to list
                return;
            }
        }
