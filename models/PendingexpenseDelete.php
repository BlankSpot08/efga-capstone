 ...
 * Page class
 */
class PendingexpenseDelete extends Pendingexpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PendingexpenseDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PendingexpenseList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PendingexpenseList"); // Return to list
                return;
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->receipt->UseColorbox) {
                ...
                $this->receipt->LinkAttrs["data-rel"] = "pendingexpense_x_receipt";
