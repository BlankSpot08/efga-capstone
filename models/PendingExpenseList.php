 ...
 * Page class
 */
class PendingExpenseList extends PendingExpense
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'pending_expense';

    // Page object name
    public $PageObjName = "PendingExpenseList";
    ...
    public $FormName = "fpending_expenselist";
    ...
    public function __construct()
    {
        ...
        // Table object (pending_expense)
        if (!isset($GLOBALS["pending_expense"]) || get_class($GLOBALS["pending_expense"]) == PROJECT_NAMESPACE . "pending_expense") {
            $GLOBALS["pending_expense"] = &$this;
        }
        ...
        // Initialize URLs
        $this->AddUrl = "PendingExpenseAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PendingExpenseDelete";
        $this->MultiUpdateUrl = "PendingExpenseUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'pending_expense');
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->cashAdvance_id->AdvancedSearch->toJson(), ","); // Field cashAdvance_id
        $filterList = Concat($filterList, $this->amount->AdvancedSearch->toJson(), ","); // Field amount
        $filterList = Concat($filterList, $this->dateTrans->AdvancedSearch->toJson(), ","); // Field dateTrans
        $filterList = Concat($filterList, $this->receiptNumber->AdvancedSearch->toJson(), ","); // Field receiptNumber
        $filterList = Concat($filterList, $this->note->AdvancedSearch->toJson(), ","); // Field note
        $filterList = Concat($filterList, $this->submittedBy->AdvancedSearch->toJson(), ","); // Field submittedBy
        $filterList = Concat($filterList, $this->status->AdvancedSearch->toJson(), ","); // Field status
        $filterList = Concat($filterList, $this->dateClosed->AdvancedSearch->toJson(), ","); // Field dateClosed
        $filterList = Concat($filterList, $this->float_status->AdvancedSearch->toJson(), ","); // Field float_status
        $filterList = Concat($filterList, $this->cash_float->AdvancedSearch->toJson(), ","); // Field cash_float
        $filterList = Concat($filterList, $this->validatedBy->AdvancedSearch->toJson(), ","); // Field validatedBy
        $filterList = Concat($filterList, $this->machine_id->AdvancedSearch->toJson(), ","); // Field machine_id
        $filterList = Concat($filterList, $this->expCategory_id->AdvancedSearch->toJson(), ","); // Field expCategory_id
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpending_expensesrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field cashAdvance_id
        $this->cashAdvance_id->AdvancedSearch->SearchValue = @$filter["x_cashAdvance_id"];
        $this->cashAdvance_id->AdvancedSearch->SearchOperator = @$filter["z_cashAdvance_id"];
        $this->cashAdvance_id->AdvancedSearch->SearchCondition = @$filter["v_cashAdvance_id"];
        $this->cashAdvance_id->AdvancedSearch->SearchValue2 = @$filter["y_cashAdvance_id"];
        $this->cashAdvance_id->AdvancedSearch->SearchOperator2 = @$filter["w_cashAdvance_id"];
        $this->cashAdvance_id->AdvancedSearch->save();
        ...
        // Field dateTrans
        $this->dateTrans->AdvancedSearch->SearchValue = @$filter["x_dateTrans"];
        $this->dateTrans->AdvancedSearch->SearchOperator = @$filter["z_dateTrans"];
        $this->dateTrans->AdvancedSearch->SearchCondition = @$filter["v_dateTrans"];
        $this->dateTrans->AdvancedSearch->SearchValue2 = @$filter["y_dateTrans"];
        $this->dateTrans->AdvancedSearch->SearchOperator2 = @$filter["w_dateTrans"];
        $this->dateTrans->AdvancedSearch->save();

        // Field receiptNumber
        $this->receiptNumber->AdvancedSearch->SearchValue = @$filter["x_receiptNumber"];
        $this->receiptNumber->AdvancedSearch->SearchOperator = @$filter["z_receiptNumber"];
        $this->receiptNumber->AdvancedSearch->SearchCondition = @$filter["v_receiptNumber"];
        $this->receiptNumber->AdvancedSearch->SearchValue2 = @$filter["y_receiptNumber"];
        $this->receiptNumber->AdvancedSearch->SearchOperator2 = @$filter["w_receiptNumber"];
        $this->receiptNumber->AdvancedSearch->save();
        ...
        // Field submittedBy
        $this->submittedBy->AdvancedSearch->SearchValue = @$filter["x_submittedBy"];
        $this->submittedBy->AdvancedSearch->SearchOperator = @$filter["z_submittedBy"];
        $this->submittedBy->AdvancedSearch->SearchCondition = @$filter["v_submittedBy"];
        $this->submittedBy->AdvancedSearch->SearchValue2 = @$filter["y_submittedBy"];
        $this->submittedBy->AdvancedSearch->SearchOperator2 = @$filter["w_submittedBy"];
        ...
        // Field dateClosed
        $this->dateClosed->AdvancedSearch->SearchValue = @$filter["x_dateClosed"];
        $this->dateClosed->AdvancedSearch->SearchOperator = @$filter["z_dateClosed"];
        $this->dateClosed->AdvancedSearch->SearchCondition = @$filter["v_dateClosed"];
        $this->dateClosed->AdvancedSearch->SearchValue2 = @$filter["y_dateClosed"];
        $this->dateClosed->AdvancedSearch->SearchOperator2 = @$filter["w_dateClosed"];
        $this->dateClosed->AdvancedSearch->save();

        // Field float_status
        $this->float_status->AdvancedSearch->SearchValue = @$filter["x_float_status"];
        $this->float_status->AdvancedSearch->SearchOperator = @$filter["z_float_status"];
        $this->float_status->AdvancedSearch->SearchCondition = @$filter["v_float_status"];
        $this->float_status->AdvancedSearch->SearchValue2 = @$filter["y_float_status"];
        $this->float_status->AdvancedSearch->SearchOperator2 = @$filter["w_float_status"];
        $this->float_status->AdvancedSearch->save();

        // Field cash_float
        $this->cash_float->AdvancedSearch->SearchValue = @$filter["x_cash_float"];
        $this->cash_float->AdvancedSearch->SearchOperator = @$filter["z_cash_float"];
        $this->cash_float->AdvancedSearch->SearchCondition = @$filter["v_cash_float"];
        $this->cash_float->AdvancedSearch->SearchValue2 = @$filter["y_cash_float"];
        $this->cash_float->AdvancedSearch->SearchOperator2 = @$filter["w_cash_float"];
        $this->cash_float->AdvancedSearch->save();

        // Field validatedBy
        $this->validatedBy->AdvancedSearch->SearchValue = @$filter["x_validatedBy"];
        $this->validatedBy->AdvancedSearch->SearchOperator = @$filter["z_validatedBy"];
        $this->validatedBy->AdvancedSearch->SearchCondition = @$filter["v_validatedBy"];
        $this->validatedBy->AdvancedSearch->SearchValue2 = @$filter["y_validatedBy"];
        $this->validatedBy->AdvancedSearch->SearchOperator2 = @$filter["w_validatedBy"];
        $this->validatedBy->AdvancedSearch->save();

        // Field machine_id
        $this->machine_id->AdvancedSearch->SearchValue = @$filter["x_machine_id"];
        $this->machine_id->AdvancedSearch->SearchOperator = @$filter["z_machine_id"];
        $this->machine_id->AdvancedSearch->SearchCondition = @$filter["v_machine_id"];
        $this->machine_id->AdvancedSearch->SearchValue2 = @$filter["y_machine_id"];
        $this->machine_id->AdvancedSearch->SearchOperator2 = @$filter["w_machine_id"];
        $this->machine_id->AdvancedSearch->save();

        // Field expCategory_id
        $this->expCategory_id->AdvancedSearch->SearchValue = @$filter["x_expCategory_id"];
        $this->expCategory_id->AdvancedSearch->SearchOperator = @$filter["z_expCategory_id"];
        $this->expCategory_id->AdvancedSearch->SearchCondition = @$filter["v_expCategory_id"];
        $this->expCategory_id->AdvancedSearch->SearchValue2 = @$filter["y_expCategory_id"];
        $this->expCategory_id->AdvancedSearch->SearchOperator2 = @$filter["w_expCategory_id"];
        $this->expCategory_id->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->cashAdvance_id, $default, false); // cashAdvance_id
        $this->buildSearchSql($where, $this->amount, $default, false); // amount
        $this->buildSearchSql($where, $this->dateTrans, $default, false); // dateTrans
        $this->buildSearchSql($where, $this->receiptNumber, $default, false); // receiptNumber
        $this->buildSearchSql($where, $this->note, $default, false); // note
        $this->buildSearchSql($where, $this->submittedBy, $default, true); // submittedBy
        $this->buildSearchSql($where, $this->status, $default, false); // status
        $this->buildSearchSql($where, $this->dateClosed, $default, false); // dateClosed
        $this->buildSearchSql($where, $this->float_status, $default, false); // float_status
        $this->buildSearchSql($where, $this->cash_float, $default, false); // cash_float
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->cashAdvance_id->AdvancedSearch->save(); // cashAdvance_id
            $this->amount->AdvancedSearch->save(); // amount
            $this->dateTrans->AdvancedSearch->save(); // dateTrans
            $this->receiptNumber->AdvancedSearch->save(); // receiptNumber
            $this->note->AdvancedSearch->save(); // note
            $this->submittedBy->AdvancedSearch->save(); // submittedBy
            $this->status->AdvancedSearch->save(); // status
            $this->dateClosed->AdvancedSearch->save(); // dateClosed
            $this->float_status->AdvancedSearch->save(); // float_status
            $this->cash_float->AdvancedSearch->save(); // cash_float
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->note;
        $searchFlds[] = &$this->submittedBy;
        $searchFlds[] = &$this->validatedBy;
        $searchFlds[] = &$this->machine_id;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->cashAdvance_id->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->amount->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->dateTrans->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->receiptNumber->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->dateClosed->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->float_status->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->cash_float->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->cashAdvance_id->AdvancedSearch->unsetSession();
        $this->amount->AdvancedSearch->unsetSession();
        $this->dateTrans->AdvancedSearch->unsetSession();
        $this->receiptNumber->AdvancedSearch->unsetSession();
        ...
        $this->float_status->AdvancedSearch->unsetSession();
        $this->cash_float->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->cashAdvance_id->AdvancedSearch->load();
        $this->amount->AdvancedSearch->load();
        $this->dateTrans->AdvancedSearch->load();
        $this->receiptNumber->AdvancedSearch->load();
        $this->note->AdvancedSearch->load();
        $this->submittedBy->AdvancedSearch->load();
        $this->status->AdvancedSearch->load();
        $this->dateClosed->AdvancedSearch->load();
        $this->float_status->AdvancedSearch->load();
        $this->cash_float->AdvancedSearch->load();
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpending_expenselist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpending_expenselist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("cashAdvance_id", $this->createColumnOption("cashAdvance_id"));
            $option->add("amount", $this->createColumnOption("amount"));
            $option->add("dateTrans", $this->createColumnOption("dateTrans"));
            $option->add("receipt", $this->createColumnOption("receipt"));
            $option->add("receiptNumber", $this->createColumnOption("receiptNumber"));
            $option->add("submittedBy", $this->createColumnOption("submittedBy"));
            $option->add("status", $this->createColumnOption("status"));
            $option->add("dateClosed", $this->createColumnOption("dateClosed"));
            $option->add("float_status", $this->createColumnOption("float_status"));
            $option->add("cash_float", $this->createColumnOption("cash_float"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpending_expensesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpending_expensesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpending_expenselist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        // cashAdvance_id
        if ($this->cashAdvance_id->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->cashAdvance_id->AdvancedSearch->SearchValue != "" || $this->cashAdvance_id->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // dateTrans
        if ($this->dateTrans->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->dateTrans->AdvancedSearch->SearchValue != "" || $this->dateTrans->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // receiptNumber
        if ($this->receiptNumber->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->receiptNumber->AdvancedSearch->SearchValue != "" || $this->receiptNumber->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // dateClosed
        if ($this->dateClosed->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->dateClosed->AdvancedSearch->SearchValue != "" || $this->dateClosed->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // float_status
        if ($this->float_status->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->float_status->AdvancedSearch->SearchValue != "" || $this->float_status->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // cash_float
        if ($this->cash_float->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->cash_float->AdvancedSearch->SearchValue != "" || $this->cash_float->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->receipt->UseColorbox) {
                ...
                $this->receipt->LinkAttrs["data-rel"] = "pending_expense_x" . $this->RowCount . "_receipt";
            ...
            $this->dateTrans->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->dateTrans->AdvancedSearch->SearchValue, $this->dateTrans->formatPattern()), $this->dateTrans->formatPattern()));
            ...
            if (!$this->receiptNumber->Raw) {
                $this->receiptNumber->AdvancedSearch->SearchValue = HtmlDecode($this->receiptNumber->AdvancedSearch->SearchValue);
            }
            $this->receiptNumber->EditValue = HtmlEncode($this->receiptNumber->AdvancedSearch->SearchValue);
            ...
            $this->dateClosed->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->dateClosed->AdvancedSearch->SearchValue, $this->dateClosed->formatPattern()), $this->dateClosed->formatPattern()));
            ...
            $this->cash_float->EditValue = HtmlEncode($this->cash_float->AdvancedSearch->SearchValue);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fpending_expenselist" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpending_expensesrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
