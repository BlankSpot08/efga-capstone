 ...
 * Page class
 */
class EmpExpenseSubcategoryDelete extends EmpExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpenseSubcategoryDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmpExpenseSubcategoryList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmpExpenseSubcategoryList"); // Return to list
                return;
            }
        }
