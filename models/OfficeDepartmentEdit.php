 ...
 * Page class
 */
class OfficeDepartmentEdit extends OfficeDepartment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "OfficeDepartmentEdit";
    ...
    protected function editRow()
    {
        ...
        if ($this->officeDepartment->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`officeDepartment` = '" . AdjustSql($this->officeDepartment->CurrentValue, $this->Dbid) . "')";
