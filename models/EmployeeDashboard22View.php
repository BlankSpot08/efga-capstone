 ...
 * Page class
 */
class EmployeeDashboard22View extends EmployeeDashboard22
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeDashboard22View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeeDashboard22List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmployeeDashboard22List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmployeeDashboard22List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmployeeDashboard22List"), "", $this->TableVar, true);
        $pageId = "view";
