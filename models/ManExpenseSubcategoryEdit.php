 ...
 * Page class
 */
class ManExpenseSubcategoryEdit extends ManExpenseSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseSubcategoryEdit";
    ...
    protected function editRow()
    {
        ...
        if ($this->expSubcategory->CurrentValue != "") { // Check field with unique index
            $filterChk = "(`expSubcategory` = '" . AdjustSql($this->expSubcategory->CurrentValue, $this->Dbid) . "')";
