...
/**
 * Table class for man monthly expense
 */
class Manmonthlyexpense extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'manmonthlyexpense';
        $this->TableName = 'man monthly expense';
        $this->TableType = 'VIEW';
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ManmonthlyexpenseList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ManmonthlyexpenseView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ManmonthlyexpenseEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ManmonthlyexpenseAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ManmonthlyexpenseView";
            case Config("API_ADD_ACTION"):
                return "ManmonthlyexpenseAdd";
            case Config("API_EDIT_ACTION"):
                return "ManmonthlyexpenseEdit";
            case Config("API_DELETE_ACTION"):
                return "ManmonthlyexpenseDelete";
            case Config("API_LIST_ACTION"):
                return "ManmonthlyexpenseList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ManmonthlyexpenseView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ManmonthlyexpenseView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ManmonthlyexpenseAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ManmonthlyexpenseAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ManmonthlyexpenseEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ManmonthlyexpenseAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ManmonthlyexpenseDelete", $this->getUrlParm());
    }
