 ...
 * Page class
 */
class CashAdvanceRequestEdit extends CashAdvanceRequest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceRequestEdit";
    ...
    public function run()
    {
        ...
        $this->expSubcategory_id->Required = false;
        $this->budget_id->Required = false;
        $this->note->Required = false;
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // dateReceived
            $this->dateReceived->setDbValueDef($rsnew, UnFormatDateTime($this->dateReceived->CurrentValue, $this->dateReceived->formatPattern()), null, $this->dateReceived->ReadOnly);
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['dateReceived']); // dateReceived
