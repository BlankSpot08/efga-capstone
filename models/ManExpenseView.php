 ...
 * Page class
 */
class ManExpenseView extends ManExpense
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ManExpenseView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ManExpenseList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ManExpenseList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "ManExpenseList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
