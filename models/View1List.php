...
class View1List extends View1
{
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->EXPENSE); // EXPENSE
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("EXPENSE", $this->createColumnOption("EXPENSE"));
        }
    ...
    public function loadRowValues($rs = null)
    {
        ...
        $this->EXPENSE->setDbValue($row['EXPENSE']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            // EXPENSE
            $this->EXPENSE->ViewValue = $this->EXPENSE->CurrentValue;
            $this->EXPENSE->ViewValue = FormatNumber($this->EXPENSE->ViewValue, $this->EXPENSE->formatPattern());
            $this->EXPENSE->ViewCustomAttributes = "";

            // EXPENSE
            $this->EXPENSE->LinkCustomAttributes = "";
            $this->EXPENSE->HrefValue = "";
            $this->EXPENSE->TooltipValue = "";
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" form="fview1list" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmailText") . '" data-sel="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
