 ...
 * Page class
 */
class EmployeeDashboard2View extends EmployeeDashboard2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeeDashboard2View";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "EmployeeDashboard2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "EmployeeDashboard2List"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "EmployeeDashboard2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmployeeDashboard2List"), "", $this->TableVar, true);
        $pageId = "view";
