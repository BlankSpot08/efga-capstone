 ...
 * Page class
 */
class CashAdvanceRequestDelete extends CashAdvanceRequest
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceRequestDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CashAdvanceRequestList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CashAdvanceRequestList"); // Return to list
                return;
            }
        }
