 ...
 * Page class
 */
class EmployeeDashboard2Summary extends EmployeeDashboard2
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'Employee Dashboard2';

    // Page object name
    public $PageObjName = "EmployeeDashboard2Summary";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Employee Dashboard2');
        }
