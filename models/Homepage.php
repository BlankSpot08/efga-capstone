...
class Homepage
{
    ...
    // Table name
    public $TableName = 'homepage.php';

    // Page object name
    public $PageObjName = "Homepage";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'homepage.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "homepage", CurrentUrl(), "", "homepage", true);
        $this->Heading = $Language->TablePhrase("homepage", "TblCaption");
    }
