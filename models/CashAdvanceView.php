 ...
 * Page class
 */
class CashAdvanceView extends CashAdvance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CashAdvanceView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CashAdvanceList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "CashAdvanceList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "CashAdvanceList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
