 ...
 * Page class
 */
class UserAccountDelete extends UserAccount
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UserAccountDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UserAccountList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("UserAccountList"); // Return to list
            return;
        }
