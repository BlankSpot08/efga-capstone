...
/**
 * Table class for utilities
 */
class Utilities extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UtilitiesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "UtilitiesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "UtilitiesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UtilitiesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_EDIT_ACTION"):
                return "UtilitiesEdit";
            case Config("API_DELETE_ACTION"):
                return "UtilitiesDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UtilitiesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UtilitiesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UtilitiesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UtilitiesAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UtilitiesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UtilitiesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UtilitiesDelete", $this->getUrlParm());
    }
