 ...
 * Page class
 */
class MachineCategoryView extends MachineCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MachineCategoryView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MachineCategoryList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MachineCategoryList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MachineCategoryList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
