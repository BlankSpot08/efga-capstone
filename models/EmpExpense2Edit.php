 ...
 * Page class
 */
class EmpExpense2Edit extends EmpExpense2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmpExpense2Edit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("EmpExpense2List"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "EmpExpense2List") {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // machine_id
            $this->machine_id->setDbValueDef($rsnew, $this->machine_id->CurrentValue, 0, $this->machine_id->ReadOnly);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("EmpExpense2List"), "", $this->TableVar, true);
        $pageId = "edit";
