...
/**
 * Table class for emp_expense2
 */
class EmpExpense2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'emp_expense2';
        $this->TableName = 'emp_expense2';
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->cashAdvance_id->Lookup = new Lookup('cashAdvance_id', 'cash_advance', false, 'id', ["expCategory_id","expSubcategory_id","submittedBy",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`expCategory_id`, ''),'" . ValueSeparator(1, $this->cashAdvance_id) . "',COALESCE(`expSubcategory_id`,''),'" . ValueSeparator(2, $this->cashAdvance_id) . "',COALESCE(`submittedBy`,''))");
                break;
            default:
                $this->cashAdvance_id->Lookup = new Lookup('cashAdvance_id', 'cash_advance', false, 'id', ["expCategory_id","expSubcategory_id","submittedBy",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`expCategory_id`, ''),'" . ValueSeparator(1, $this->cashAdvance_id) . "',COALESCE(`expSubcategory_id`,''),'" . ValueSeparator(2, $this->cashAdvance_id) . "',COALESCE(`submittedBy`,''))");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->status->Lookup = new Lookup('status', 'emp_expense2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->status->Lookup = new Lookup('status', 'emp_expense2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->float_status->Lookup = new Lookup('float_status', 'emp_expense2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->float_status->Lookup = new Lookup('float_status', 'emp_expense2', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
        ...
        $this->machine_id->Nullable = false; // NOT NULL field
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("EmpExpense2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "EmpExpense2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "EmpExpense2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "EmpExpense2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "EmpExpense2View";
            case Config("API_ADD_ACTION"):
                return "EmpExpense2Add";
            case Config("API_EDIT_ACTION"):
                return "EmpExpense2Edit";
            case Config("API_DELETE_ACTION"):
                return "EmpExpense2Delete";
            case Config("API_LIST_ACTION"):
                return "EmpExpense2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("EmpExpense2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("EmpExpense2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "EmpExpense2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "EmpExpense2Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("EmpExpense2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("EmpExpense2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("EmpExpense2Delete", $this->getUrlParm());
    }
    ...
    public function renderListRow()
    {
        ...
        if ($this->receipt->UseColorbox) {
            ...
            $this->receipt->LinkAttrs["data-rel"] = "emp_expense2_x_receipt";
    ...
    public function renderEditRow()
    {
        ...
        $this->validatedBy->EditValue = FormatNumber($this->validatedBy->EditValue, $this->validatedBy->formatPattern());
        $this->validatedBy->ViewCustomAttributes = "";
