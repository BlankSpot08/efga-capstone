 ...
 * Page class
 */
class EmployeePositionDelete extends EmployeePosition
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "EmployeePositionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("EmployeePositionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("EmployeePositionList"); // Return to list
                return;
            }
        }
