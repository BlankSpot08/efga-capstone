 ...
 * Page class
 */
class BudgetView extends Budget
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "BudgetList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "BudgetList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "BudgetList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
