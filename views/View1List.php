...
<?php if ($Page->EXPENSE->Visible) { // EXPENSE ?>
        <th data-name="EXPENSE" class="<?= $Page->EXPENSE->headerCellClass() ?>"><div id="elh_view1_EXPENSE" class="view1_EXPENSE"><?= $Page->renderFieldHeader($Page->EXPENSE) ?></div></th>
<?php } ?>
<?php
...
?>
    <?php if ($Page->EXPENSE->Visible) { // EXPENSE ?>
        <td data-name="EXPENSE"<?= $Page->EXPENSE->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_view1_EXPENSE" class="el_view1_EXPENSE">
<span<?= $Page->EXPENSE->viewAttributes() ?>>
<?= $Page->EXPENSE->getViewValue() ?></span>
</span>
</td>
    <?php } ?>
<?php
