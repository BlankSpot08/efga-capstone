...
var fcash_advance_requestview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcash_advance_requestview = new ew.Form("fcash_advance_requestview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fcash_advance_requestview;
    loadjs.done("fcash_advance_requestview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fcash_advance_requestview" id="fcash_advance_requestview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->expCategory_id->Visible) { // expCategory_id ?>
    <tr id="r_expCategory_id"<?= $Page->expCategory_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_expCategory_id"><?= $Page->expCategory_id->caption() ?></span></td>
...
<?php if ($Page->expSubcategory_id->Visible) { // expSubcategory_id ?>
    <tr id="r_expSubcategory_id"<?= $Page->expSubcategory_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_expSubcategory_id"><?= $Page->expSubcategory_id->caption() ?></span></td>
...
<?php if ($Page->budget_id->Visible) { // budget_id ?>
    <tr id="r_budget_id"<?= $Page->budget_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_budget_id"><?= $Page->budget_id->caption() ?></span></td>
...
<?php if ($Page->machine_id->Visible) { // machine_id ?>
    <tr id="r_machine_id"<?= $Page->machine_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_machine_id"><?= $Page->machine_id->caption() ?></span></td>
...
<?php if ($Page->dateReceived->Visible) { // dateReceived ?>
    <tr id="r_dateReceived"<?= $Page->dateReceived->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_dateReceived"><?= $Page->dateReceived->caption() ?></span></td>
...
<?php if ($Page->submittedBy->Visible) { // submittedBy ?>
    <tr id="r_submittedBy"<?= $Page->submittedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_submittedBy"><?= $Page->submittedBy->caption() ?></span></td>
...
<?php if ($Page->note->Visible) { // note ?>
    <tr id="r_note"<?= $Page->note->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_note"><?= $Page->note->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status"<?= $Page->status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->validatedBy->Visible) { // validatedBy ?>
    <tr id="r_validatedBy"<?= $Page->validatedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cash_advance_request_validatedBy"><?= $Page->validatedBy->caption() ?></span></td>
        <td data-name="validatedBy"<?= $Page->validatedBy->cellAttributes() ?>>
<span id="el_cash_advance_request_validatedBy">
