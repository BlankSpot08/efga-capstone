...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/site_icon.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/site_icon.ico">
<meta name="generator" content="PHPMaker 2022.8.0">
</head>
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="#" data-ew-action="none">
                    <img src="<?= GetUrl("images/header.png") ?>" alt="" class="brand-image ew-brand-image">
                </a>
            </ul>
            <!-- Right navbar links -->
