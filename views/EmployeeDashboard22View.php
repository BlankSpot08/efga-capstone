...
var fEmployeeDashboard22view;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fEmployeeDashboard22view = new ew.Form("fEmployeeDashboard22view", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fEmployeeDashboard22view;
    loadjs.done("fEmployeeDashboard22view");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fEmployeeDashboard22view" id="fEmployeeDashboard22view" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_id"><?= $Page->id->caption() ?></span></td>
        <td data-name="id"<?= $Page->id->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_id">
...
<?php if ($Page->cashAdvance_id->Visible) { // cashAdvance_id ?>
    <tr id="r_cashAdvance_id"<?= $Page->cashAdvance_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_cashAdvance_id"><?= $Page->cashAdvance_id->caption() ?></span></td>
        <td data-name="cashAdvance_id"<?= $Page->cashAdvance_id->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_cashAdvance_id">
...
<?php if ($Page->amount->Visible) { // amount ?>
    <tr id="r_amount"<?= $Page->amount->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_amount"><?= $Page->amount->caption() ?></span></td>
        <td data-name="amount"<?= $Page->amount->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_amount">
...
<?php if ($Page->dateTrans->Visible) { // dateTrans ?>
    <tr id="r_dateTrans"<?= $Page->dateTrans->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_dateTrans"><?= $Page->dateTrans->caption() ?></span></td>
        <td data-name="dateTrans"<?= $Page->dateTrans->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_dateTrans">
...
<?php if ($Page->receiptNumber->Visible) { // receiptNumber ?>
    <tr id="r_receiptNumber"<?= $Page->receiptNumber->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_receiptNumber"><?= $Page->receiptNumber->caption() ?></span></td>
        <td data-name="receiptNumber"<?= $Page->receiptNumber->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_receiptNumber">
...
<?php if ($Page->receipt->Visible) { // receipt ?>
    <tr id="r_receipt"<?= $Page->receipt->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_receipt"><?= $Page->receipt->caption() ?></span></td>
        <td data-name="receipt"<?= $Page->receipt->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_receipt">
<span>
...
<?php if ($Page->note->Visible) { // note ?>
    <tr id="r_note"<?= $Page->note->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_note"><?= $Page->note->caption() ?></span></td>
        <td data-name="note"<?= $Page->note->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_note">
...
<?php if ($Page->submittedBy->Visible) { // submittedBy ?>
    <tr id="r_submittedBy"<?= $Page->submittedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_submittedBy"><?= $Page->submittedBy->caption() ?></span></td>
        <td data-name="submittedBy"<?= $Page->submittedBy->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_submittedBy">
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status"<?= $Page->status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_status"><?= $Page->status->caption() ?></span></td>
        <td data-name="status"<?= $Page->status->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_status">
...
<?php if ($Page->dateClosed->Visible) { // dateClosed ?>
    <tr id="r_dateClosed"<?= $Page->dateClosed->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_dateClosed"><?= $Page->dateClosed->caption() ?></span></td>
        <td data-name="dateClosed"<?= $Page->dateClosed->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_dateClosed">
...
<?php if ($Page->float_status->Visible) { // float_status ?>
    <tr id="r_float_status"<?= $Page->float_status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_float_status"><?= $Page->float_status->caption() ?></span></td>
        <td data-name="float_status"<?= $Page->float_status->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_float_status">
...
<?php if ($Page->cash_float->Visible) { // cash_float ?>
    <tr id="r_cash_float"<?= $Page->cash_float->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_cash_float"><?= $Page->cash_float->caption() ?></span></td>
        <td data-name="cash_float"<?= $Page->cash_float->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_cash_float">
...
<?php if ($Page->validatedBy->Visible) { // validatedBy ?>
    <tr id="r_validatedBy"<?= $Page->validatedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_validatedBy"><?= $Page->validatedBy->caption() ?></span></td>
        <td data-name="validatedBy"<?= $Page->validatedBy->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_validatedBy">
...
<?php if ($Page->machine_id->Visible) { // machine_id ?>
    <tr id="r_machine_id"<?= $Page->machine_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_machine_id"><?= $Page->machine_id->caption() ?></span></td>
        <td data-name="machine_id"<?= $Page->machine_id->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_machine_id">
...
<?php if ($Page->expCategory_id->Visible) { // expCategory_id ?>
    <tr id="r_expCategory_id"<?= $Page->expCategory_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_EmployeeDashboard22_expCategory_id"><?= $Page->expCategory_id->caption() ?></span></td>
        <td data-name="expCategory_id"<?= $Page->expCategory_id->cellAttributes() ?>>
<span id="el_EmployeeDashboard22_expCategory_id">
