...
// Page object
$EmpExpenseSubcategoryView = &$Page;
?>
...
var femp_expense_subcategoryview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    femp_expense_subcategoryview = new ew.Form("femp_expense_subcategoryview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = femp_expense_subcategoryview;
    loadjs.done("femp_expense_subcategoryview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="femp_expense_subcategoryview" id="femp_expense_subcategoryview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_subcategory_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->expCategory->Visible) { // expCategory ?>
    <tr id="r_expCategory"<?= $Page->expCategory->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_subcategory_expCategory"><?= $Page->expCategory->caption() ?></span></td>
...
<?php if ($Page->expSubcategory->Visible) { // expSubcategory ?>
    <tr id="r_expSubcategory"<?= $Page->expSubcategory->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_subcategory_expSubcategory"><?= $Page->expSubcategory->caption() ?></span></td>
