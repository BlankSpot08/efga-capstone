...
var femp_expenseview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    femp_expenseview = new ew.Form("femp_expenseview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = femp_expenseview;
    loadjs.done("femp_expenseview");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="femp_expenseview" id="femp_expenseview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->cashAdvance_id->Visible) { // cashAdvance_id ?>
    <tr id="r_cashAdvance_id"<?= $Page->cashAdvance_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_cashAdvance_id"><?= $Page->cashAdvance_id->caption() ?></span></td>
...
<?php if ($Page->amount->Visible) { // amount ?>
    <tr id="r_amount"<?= $Page->amount->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_amount"><?= $Page->amount->caption() ?></span></td>
...
<?php if ($Page->dateTrans->Visible) { // dateTrans ?>
    <tr id="r_dateTrans"<?= $Page->dateTrans->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_dateTrans"><?= $Page->dateTrans->caption() ?></span></td>
...
<?php if ($Page->receiptNumber->Visible) { // receiptNumber ?>
    <tr id="r_receiptNumber"<?= $Page->receiptNumber->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_receiptNumber"><?= $Page->receiptNumber->caption() ?></span></td>
...
<?php if ($Page->receipt->Visible) { // receipt ?>
    <tr id="r_receipt"<?= $Page->receipt->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_receipt"><?= $Page->receipt->caption() ?></span></td>
...
<?php if ($Page->note->Visible) { // note ?>
    <tr id="r_note"<?= $Page->note->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_note"><?= $Page->note->caption() ?></span></td>
...
<?php if ($Page->submittedBy->Visible) { // submittedBy ?>
    <tr id="r_submittedBy"<?= $Page->submittedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_submittedBy"><?= $Page->submittedBy->caption() ?></span></td>
...
<?php if ($Page->status->Visible) { // status ?>
    <tr id="r_status"<?= $Page->status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_status"><?= $Page->status->caption() ?></span></td>
...
<?php if ($Page->dateClosed->Visible) { // dateClosed ?>
    <tr id="r_dateClosed"<?= $Page->dateClosed->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_dateClosed"><?= $Page->dateClosed->caption() ?></span></td>
...
<?php if ($Page->float_status->Visible) { // float_status ?>
    <tr id="r_float_status"<?= $Page->float_status->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_float_status"><?= $Page->float_status->caption() ?></span></td>
...
<?php if ($Page->validatedBy->Visible) { // validatedBy ?>
    <tr id="r_validatedBy"<?= $Page->validatedBy->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_validatedBy"><?= $Page->validatedBy->caption() ?></span></td>
...
<?php if ($Page->machine_id->Visible) { // machine_id ?>
    <tr id="r_machine_id"<?= $Page->machine_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_machine_id"><?= $Page->machine_id->caption() ?></span></td>
...
<?php if ($Page->cash_float->Visible) { // cash_float ?>
    <tr id="r_cash_float"<?= $Page->cash_float->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_cash_float"><?= $Page->cash_float->caption() ?></span></td>
...
<?php if ($Page->expCategory_id->Visible) { // expCategory_id ?>
    <tr id="r_expCategory_id"<?= $Page->expCategory_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_emp_expense_expCategory_id"><?= $Page->expCategory_id->caption() ?></span></td>
...
loadjs.ready("load", function () {
    ...
    $(document).ready(function(){ 
        $("#r_machine_id").hide(); 
        if ($("#el_emp_expense_expCategory_id")[0].textContent.trim() == "3") {  
            $("#r_machine_id").show(); 
        }
